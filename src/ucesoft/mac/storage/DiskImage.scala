...
object DiskImage:
  ...
  enum DiskEncoding(val rawByteSize: Int,
    ...
    case MFM1440K extends DiskEncoding(1_474_560, 2, Array(getSectorInterleave(4, 18)), 0x22)
    case MFM720K extends DiskEncoding(737_280, 2, Array(getSectorInterleave(4, 9)), 0x22)
